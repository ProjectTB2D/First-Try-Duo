...
_app = new sf::RenderWindow(sf::VideoMode(x,y,32), "Fabengine");
...
/*
    if (!MyFont.loadFromFile(std::string("digital-7.ttf"), 50))
    {
    cout << "failed to load fonts;...." << endl;
    }

    sf::String texte("lol", MyFont);

    texte.SetText("NO TEXT");
    //texte.SetFont(MyFont);
    texte.SetSize(25);
    texte.SetColor(sf::Color::White);
    texte.SetPosition(50,40);
    char txt[4];
     sf::Clock lagrefresh;
*/
...
/*
    ...
    if (!MyFont.LoadFromFile("digital-7.ttf", 50))
    {
    cout << "failed to load fonts;...." << endl;
    }
